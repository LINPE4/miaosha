...
(1,1,10,9,'2018-05-28 13:17:07','2018-10-21 23:11:06'),
(2,2,20,20,'2018-04-30 13:17:34','2018-10-28 23:11:12');
...
CREATE TABLE `miaosha_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13726204412 DEFAULT CHARSET=utf8mb4;
...
(13726204411,'peter','b7797cce01b4b131b433b6acf4add449','1a2b3c4d',NULL,'2018-05-27 14:49:50','2018-05-27 14:49:53',0);
...
insert  into `order_info`(`id`,`user_id`,`goods_id`,`delivery_addr_id`,`goods_name`,`goods_count`,`goods_price`,`order_channel`,`status`,`create_date`,`pay_date`) values 
(2,13726204411,1,NULL,'华为',1,10,1,0,'2018-05-28 23:29:36',NULL),
(3,13726204411,2,NULL,'苹果',1,20,1,0,'2018-10-11 22:39:39',NULL),
(4,13726204411,2,NULL,'苹果',1,20,1,0,'2018-10-11 22:40:25',NULL),
(5,13726204411,2,NULL,'苹果',1,20,1,0,'2018-10-11 22:45:29',NULL),
(6,13726204411,1,NULL,'华为',1,10,1,0,'2018-10-17 22:27:30',NULL);
